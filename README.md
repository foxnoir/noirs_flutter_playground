...
Practice app for **Riverpod**: providers, labs (listen, ConsumerWidget, refresh / invalidate, User List with data source + repository, User Search), Freezed, and sealed error mapping.
