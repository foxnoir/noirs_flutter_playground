...
void main() {
  ...
  testWidgets('ItemDetailsScreen shows the item', (tester) async {
  ...
  testWidgets('ItemDetailsScreen maps missing id to errorNotFound', (
    tester,
  ) async {
    await tester.pumpWidget(
      ProviderScope(
