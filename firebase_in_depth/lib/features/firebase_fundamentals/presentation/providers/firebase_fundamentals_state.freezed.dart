...
mixin _$FirebaseFundamentalsState {
 ...
 AsyncValue<Course>? get document; AsyncValue<List<Course>>? get collection; AsyncValue<List<Course>>? get validQuery; AsyncValue<List<Course>>? get invalidQuery; AsyncValue<List<Course>>? get compositeQuery; AsyncValue<List<Course>>? get missingIndexQuery; AsyncValue<void>? get deniedRead; AsyncValue<List<Lesson>>? get nestedLessons; AsyncValue<List<Lesson>>? get collectionGroupLessons; AsyncValue<CoursesSnapshot>? get realtime; bool get listening; AsyncValue<void>? get increment;
...
int get hashCode {
  final _this = this as FirebaseFundamentalsState;
  return Object.hash(runtimeType,_this.document,_this.collection,_this.validQuery,_this.invalidQuery,_this.compositeQuery,_this.missingIndexQuery,_this.deniedRead,_this.nestedLessons,_this.collectionGroupLessons,_this.realtime,_this.listening,_this.increment);
}

@override
String toString() {
  final _this = this as FirebaseFundamentalsState;
  return 'FirebaseFundamentalsState(document: ${_this.document}, collection: ${_this.collection}, validQuery: ${_this.validQuery}, invalidQuery: ${_this.invalidQuery}, compositeQuery: ${_this.compositeQuery}, missingIndexQuery: ${_this.missingIndexQuery}, deniedRead: ${_this.deniedRead}, nestedLessons: ${_this.nestedLessons}, collectionGroupLessons: ${_this.collectionGroupLessons}, realtime: ${_this.realtime}, listening: ${_this.listening}, increment: ${_this.increment})';
}
...
@useResult
$Res call({
 AsyncValue<Course>? document, AsyncValue<List<Course>>? collection, AsyncValue<List<Course>>? validQuery, AsyncValue<List<Course>>? invalidQuery, AsyncValue<List<Course>>? compositeQuery, AsyncValue<List<Course>>? missingIndexQuery, AsyncValue<void>? deniedRead, AsyncValue<List<Lesson>>? nestedLessons, AsyncValue<List<Lesson>>? collectionGroupLessons, AsyncValue<CoursesSnapshot>? realtime, bool listening, AsyncValue<void>? increment
});
...
/// Create a copy of FirebaseFundamentalsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? document = freezed,Object? collection = freezed,Object? validQuery = freezed,Object? invalidQuery = freezed,Object? compositeQuery = freezed,Object? missingIndexQuery = freezed,Object? deniedRead = freezed,Object? nestedLessons = freezed,Object? collectionGroupLessons = freezed,Object? realtime = freezed,Object? listening = null,Object? increment = freezed,}) {
...
as AsyncValue<List<Course>>?,deniedRead: freezed == deniedRead ? _self.deniedRead : deniedRead // ignore: cast_nullable_to_non_nullable
as AsyncValue<void>?,nestedLessons: freezed == nestedLessons ? _self.nestedLessons : nestedLessons // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _FirebaseFundamentalsState() when $default != null:
return $default(_that.document,_that.collection,_that.validQuery,_that.invalidQuery,_that.compositeQuery,_that.missingIndexQuery,_that.deniedRead,_that.nestedLessons,_that.collectionGroupLessons,_that.realtime,_that.listening,_that.increment);case _:
  return orElse();
...
class _FirebaseFundamentalsState implements FirebaseFundamentalsState {
  const _FirebaseFundamentalsState({this.document, this.collection, this.validQuery, this.invalidQuery, this.compositeQuery, this.missingIndexQuery, this.deniedRead, this.nestedLessons, this.collectionGroupLessons, this.realtime, this.listening = false, this.increment});
...
@override final  AsyncValue<void>? deniedRead;
