...
import 'package:firebase_in_depth/features/firebase_fundamentals/presentation/widgets/firebase_fundamentals_rules_section.dart';
    ...
    return DesktopScaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 32),
          const FirebaseFundamentalsRulesSection(),
          const SizedBox(height: 32),
