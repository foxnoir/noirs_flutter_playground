...
mixin _$CourseModel {
 ...
 String get id; String get description; String get longDescription; String get url; int get seqNo; int get lessonsCount; int get price; List<String> get categories; String get icon; TutorModel get tutor;
...
String toString() {
  final _this = this as CourseModel;
  return 'CourseModel(id: ${_this.id}, description: ${_this.description}, longDescription: ${_this.longDescription}, url: ${_this.url}, seqNo: ${_this.seqNo}, lessonsCount: ${_this.lessonsCount}, price: ${_this.price}, categories: ${_this.categories}, icon: ${_this.icon}, tutor: ${_this.tutor})';
}
...
@useResult
$Res call({
 String id, String description, String longDescription, String url, int seqNo, int lessonsCount, int price, List<String> categories, String icon, TutorModel tutor
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String description,  String longDescription,  String url,  int seqNo,  int lessonsCount,  int price,  List<String> categories,  String icon,  TutorModel tutor)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CourseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String description,  String longDescription,  String url,  int seqNo,  int lessonsCount,  int price,  List<String> categories,  String icon,  TutorModel tutor)  $default,) {final _that = this;
switch (_that) {
case _CourseModel():
return $default(_that.id,_that.description,_that.longDescription,_that.url,_that.seqNo,_that.lessonsCount,_that.price,_that.categories,_that.icon,_that.tutor);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String description,  String longDescription,  String url,  int seqNo,  int lessonsCount,  int price,  List<String> categories,  String icon,  TutorModel tutor)?  $default,) {final _that = this;
switch (_that) {
case _CourseModel() when $default != null:
return $default(_that.id,_that.description,_that.longDescription,_that.url,_that.seqNo,_that.lessonsCount,_that.price,_that.categories,_that.icon,_that.tutor);case _:
  return null;
...
class _CourseModel implements CourseModel {
  const _CourseModel({required this.id, required this.description, required this.longDescription, required this.url, required this.seqNo, required this.lessonsCount, required this.price, required  List<String> categories, required this.icon, required this.tutor}): _categories = categories;
...
@override
String toString() {
    return 'CourseModel(id: $id, description: $description, longDescription: $longDescription, url: $url, seqNo: $seqNo, lessonsCount: $lessonsCount, price: $price, categories: $categories, icon: $icon, tutor: $tutor)';
}
