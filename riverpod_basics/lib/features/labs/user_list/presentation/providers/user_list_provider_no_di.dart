...
import 'package:riverpod_basics/features/labs/user_list/data/repositories/hard_wired_user_repository.dart';
...
/// [HardWiredUserRepository] itself. No `userRepositoryProvider`, no
...
class UserListNotifierNoDi extends Notifier<UserListState> {
  ...
  Future<void> fetchUsers() async {
    ...
    try {
      final users = await const HardWiredUserRepository().fetchUsers();
