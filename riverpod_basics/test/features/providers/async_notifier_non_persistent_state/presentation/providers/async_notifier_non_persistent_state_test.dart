...
void main() {
  test(
    'nonPersistentStateAsyncNotifierProvider disposes when unlistened',
    () async {
      ...
      expect(
        container.read(nonPersistentStateAsyncNotifierProvider).isLoading,
        isTrue,
      );
      expect(
        await container.read(nonPersistentStateAsyncNotifierProvider.future),
        0,
      );
      ...
      expect(
        container.exists(nonPersistentStateAsyncNotifierProvider),
        isFalse,
      );
