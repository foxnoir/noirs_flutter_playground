...
void main() {
  ...
  testWidgets(
    'Labs dropdown lists lifetimes, add user, user list, user search, listen manual, consumer widget, quote, and refresh',
    (tester) async {
      await tester.pumpWidget(app());
      ...
      expect(find.text('User Search'), findsOneWidget);
  ...
  testWidgets('Landing page lists destinations in German', (tester) async {
    ...
    expect(find.text('Benutzersuche'), findsOneWidget);
    expect(find.text('Listen Manual'), findsOneWidget);
    expect(find.text('Consumer Widget'), findsOneWidget);
    expect(find.text('Quote'), findsOneWidget);
    expect(find.text('Refresh'), findsOneWidget);
