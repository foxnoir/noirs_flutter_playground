...
Future<void> showApiHttpLabSearchSheet(BuildContext context) {
  return showModalBottomSheet<void>(
    context: context,
    isScrollControlled: true,
    showDragHandle: true,
    builder: (context) => const ApiHttpLabSearchSheet(),
  );
}

class ApiHttpLabSearchSheet extends ConsumerStatefulWidget {
  const ApiHttpLabSearchSheet({super.key});

  @override
  ConsumerState<ApiHttpLabSearchSheet> createState() =>
      _ApiHttpLabSearchSheetState();
}

class _ApiHttpLabSearchSheetState extends ConsumerState<ApiHttpLabSearchSheet> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            key: const Key('api-http-lab-search-title'),
            controller: _title,
          ...
          TextField(
            key: const Key('api-http-lab-search-author'),
            controller: _author,
            textCapitalization: TextCapitalization.words,
          ...
          FilledButton(
            key: const Key('api-http-lab-search-submit'),
