  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _LayoutLabRuleRow(
          when: l10n.layoutWindowWhen,
          then: l10n.layoutWindowCalls,
          hint: l10n.layoutWindowHint,
        ),
        const SizedBox(height: 12),
        _LayoutLabRuleRow(
          when: l10n.layoutBuilderWhen,
          then: l10n.layoutBuilderCalls,
          hint: l10n.layoutBuilderHint,
        ),
        const SizedBox(height: 12),
        _LayoutLabRuleRow(
          when: l10n.layoutMobileFirstWhen,
          then: l10n.layoutMobileFirstCalls,
          hint: l10n.layoutMobileFirstRuleHint,
        ),
